...
import { UnderwritingTable } from './components/UnderwritingTable';
    ...
    <div style={{ background: '#f1f5f9', minHeight: '100vh', padding: '1.5rem', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <div style={{ maxWidth: '1050px', margin: '0 auto' }}>
        ...
        <div style={{ marginTop: '1.5rem' }}>
          <FinanceDashboard total={records.length} alerts={alerts} />
          <UnderwritingForm onSubmit={handleFormSubmit} />
          <UnderwritingTable records={records} />
        </div>
      </div>
    </div>
  );
